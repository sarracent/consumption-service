...
import com.claro.amx.sp.dataconsumptionservice.annotations.log.LogException;
import com.claro.amx.sp.dataconsumptionservice.commons.resolver.CustomHeadersResolver;
...
import com.claro.amx.sp.dataconsumptionservice.utility.*;
import com.claro.amx.sp.dataconsumptionservice.constants.Constants;
import com.claro.amx.sp.dataconsumptionservice.constants.Errors;
...
import static com.claro.amx.sp.dataconsumptionservice.utility.Logs.Basic.*;
import static com.claro.amx.sp.dataconsumptionservice.utility.Logs.Extras.ERROR_EXECUTE;
import static com.claro.amx.sp.dataconsumptionservice.utility.Logs.Extras.START_TIME;
import static com.claro.amx.sp.dataconsumptionservice.utility.Logs.Header.*;

/**
 * Log aspect for logs to ElasticSearch.
 */
@Aspect
@Component
public class LogAspect {
    ...
    @Around("@annotation(com.claro.amx.sp.dataconsumptionservice.annotations.auditable.AuditableApi)")
    ...
    @Around("@annotation(com.claro.amx.sp.dataconsumptionservice.annotations.log.LogDAO) || @annotation(com.claro.amx.sp.dataconsumptionservice.annotations.log.LogBO) || @annotation(com.claro.amx.sp.dataconsumptionservice.annotations.log.LogService) || @annotation(com.claro.amx.sp.dataconsumptionservice.annotations.log.LogManager)")
    ...
    @Pointcut("within(com.claro.amx.sp.dataconsumptionservice..*)")
    ...
    private void updateLogParameter(String operationName, String methodName, Map<String, Object> parametersMap, Map<String, String> headersMap) {
        ...
        final String userId = headersMap.get(USER_NAME);
        ...
        ThreadContext.put(USER_ID.name(), userId);
